$(document).ready(function(){
    $('#searchUser').on('keyup', function(e){
      ...
      $.ajax({
          ...
          data:{
            client_id:'Ov23liQnEqIHx5roafLU',
            client_secret:'e699bf7fa917574bd599f87922ef5a30ae8094e1'
          }
      }).done(function(user){
        $.ajax({
        ...
        $('#profile').html(`
          <div class="card border-primary mb-3" style="max-width: 100rem;padding: 20px">
